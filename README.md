...
- Appwrite (Database + Auth + Permissions)
...
# Editar con credenciales de Appwrite
```
...
Database: Appwrite (Databases + Auth + Storage + Permissions)
...
backend, frontend, appwrite, codebase-analyst, vercel-deployer, documentacion, calidad
...
| historial | Persistencia en Appwrite |
